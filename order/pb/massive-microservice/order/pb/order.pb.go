...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\x02pb\"\xb0\x02\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x13GetOrdersForAccount\x12\x1e.pb.GetOrdersForAccountRequest\x1a\x1f.pb.GetOrdersForAccountResponse\"\x00B\"Z massive-microservice/order/pb;pbb\x06proto3"
