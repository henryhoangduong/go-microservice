...
type Service interface {
	PostProduct(ctx *context.Context, name, desctiption string, price float64) (*Product, error)
	GetProduct(ctx *context.Context, id string) (*Product, error)
	GetProducts(ctx *context.Context, skip uint64, take uint) ([]Product, error)
