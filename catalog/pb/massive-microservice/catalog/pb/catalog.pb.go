...
const file_catalog_catalog_proto_rawDesc = "" +
	"\n" +
	"\x15catalog/catalog.proto\x12\x02pb\"e\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\vGetProducts\x12\x16.pb.GetProductsRequest\x1a\x17.pb.GetProductsResponse\"\x00B$Z\"massive-microservice/catalog/pb;pbb\x06proto3"
